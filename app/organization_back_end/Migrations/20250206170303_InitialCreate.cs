        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LicenceLegerEntryId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LicenceLedgerEntries", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LicenceLedgerEntries_Licences_LicenceId",
                        column: x => x.LicenceId,
                        principalTable: "Licences",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LicenceLedgerEntries_Payments_PaymentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LicencedUserId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Entries_LicencedUserId",
                table: "Entries",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LicenceLedgerEntries_LicenceId",
                table: "LicenceLedgerEntries",
                column: "LicenceId");

            migrationBuilder.CreateIndex(
                name: "IX_LicenceLedgerEntries_PaymentId",
                table: "LicenceLedgerEntries",
                column: "PaymentId",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LicenceLedgerEntries_UserId",
                table: "LicenceLedgerEntries",
                column: "UserId");
